export default function ProductCatalogCard(): JSX.Element {
  return (
    <div className="product-card">
      <img src="img/content/catalog-product-0.png" srcSet="img/content/catalog-product-0@2x.png 2x" width="75" height="190" alt="Liana Z100" />
